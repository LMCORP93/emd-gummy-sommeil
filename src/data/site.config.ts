...
const products: Product[] = [
  {
    ...
    image: 'https://mushngo.com/cdn/shop/files/sommeil-mush-n-go-complement-reishi-valeriane-melatonine.png?v=1772654062&width=1200',
  ...
  {
    rank: 2,
    name: 'Gummies Lion’s Mane Focus',
    brand: 'Sporelife',
    slug: 'sporelife-gummies',
    image: 'https://www.sporelife.fr/cdn/shop/files/gummies-lions-mane-focus-1-complement-alimentaire-sporelife.webp?v=1769876394',
    ...
    originalPrice: '39.90€',
    discountPrice: '31.92€',
    affiliateLink: 'https://www.sporelife.fr/products/gummies-lions-mane-focus?ref=clublionsmane',
    origin: '🇫🇷 France',
    availability: 'Livraison en France possible via la boutique officielle ou un revendeur',
    productType: 'Gummies Lion’s Mane pour focus et routine bien-être',
    pros: ['Vrai format gummies Sporelife', 'Image produit cohérente avec le format à mâcher', 'Bon prix avec code promo', 'Intéressant pour une routine bien-être globale'],
    cons: ['Angle focus et bien-être global, pas sommeil pur', 'Moins direct si l’utilisateur cherche mélatonine ou endormissement', 'À garder comme alternative, pas comme recommandation principale sommeil'],
    description: 'Sporelife reste deuxième comme alternative gummies champignons, mais avec un vrai produit gummy : les Gummies Lion’s Mane Focus. Ce n’est pas le choix sommeil le plus direct, mais le format et l’univers champignons restent cohérents après Mush N Go.'
      },
  {
    rank: 3,
